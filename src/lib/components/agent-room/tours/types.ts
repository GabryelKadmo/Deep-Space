...
export type TourAction =
  ...
  | { kind: 'createToolWorkshop'; title: string }
  ...
  | { kind: 'configureAgentRuntime'; targetTitle: string; mode: 'interactive' | 'on_demand' | 'persistent'; idleMinutes?: number; concurrency?: number; usageLimit?: number }
