...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      body: `Notas são markdown vivo compartilhado com os agentes. Uma nota criada por um agente pela ponte se conecta por padrão somente àquele autor exato, então agentes paralelos e roles repetidas mantêm contextos independentes; o agente precisa escolher explicitamente --connect <agente> ou --connect all para compartilhá-la além disso. A convenção: conecte a nota a quem deve lê-la/escrevê-la e diga o propósito no título e no conteúdo. Ex.: nota “Backlog (líder escreve)” conectada ao líder — você escreve “quebre em tarefas para o time” e ele lê com orkestrai note read e distribui no quadro. Nota “Para mim (humano)” — peça ao líder para registrar status/decisões nela com orkestrai note write/edit, e você acompanha formatado (ícone de olho). Duplo-clique no título renomeia a nota. Solte, cole ou selecione imagens, PDFs, outros arquivos e links HTTP/HTTPS; arquivos de até 10 MB ficam em .orkestrai/attachments/ e a referência markdown entra no cursor. Ao remover um anexo pelo X, a referência também sai da nota e o arquivo armazenado no workspace é apagado.`,
    },
    {
      id: 'tarefas',
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Abra Roles, escolha "Descobrir em outra pasta..." e selecione o projeto que possui a role. O Deep Space valida os arquivos limitados em .orkestrai/roles desse projeto, importa apenas nomes novos e nunca sobrescreve uma role existente no workspace.',
    ...
    },
    {
      ...
      body: 'Adicione servidores MCP no editor do workspace (ex.: filesystem, web, banco) — os agentes ganham as tools nativamente, e o Deep Space em si aparece como servidor MCP com as ações do canvas (orkestrai mcp). Presets podem carregar os MCPs junto com o time.',
  ...
  changelog: [
{
  ...
  "items": [
    ...
    "A ponte dos agentes continua igual de propósito: o comando orkestrai, a pasta .orkestrai/ e as variáveis de ambiente não mudaram, porque renomeá-las quebraria workspaces existentes."
  ]
},
{
  ...
  "items": [
    ...
    },
    {
      ...
      items: [
        ...
        'Sessões MCP e CLI restauradas sem ORKESTRAI_NODE_ID podem registrar o estado no Control Center por uma tarefa atribuída ao agente real do workspace; chamadas sem nenhuma das duas fontes verificadas de identidade continuam bloqueadas.',
    ...
    },
    {
      ...
      items: [
        'Adicionado o botão "Descobrir em outra pasta..." ao lado do discover do repositório já existente em Roles: escolha qualquer pasta num diálogo nativo e o Deep Space importa toda `role.json` encontrada dentro de `.orkestrai/roles/` ali.',
