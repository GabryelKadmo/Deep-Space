  ...
  changelog: [
{
  ...
  "items": [
    ...
    "A ponte dos agentes continua igual de propósito: o comando deepspace, a pasta .deepspace/ e as variáveis de ambiente não mudaram, porque renomeá-las quebraria workspaces existentes."
  ]
},
{
