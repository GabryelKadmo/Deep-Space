...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      body: `No app desktop, um link que pede uma aba nova em primeiro ou segundo plano é interceptado antes que o Electron crie uma janela externa. O Orkestrai cria outro nó Portal no mesmo Canvas, posiciona ao lado da origem sem cobrir nós existentes, usa o host de destino como nome, abre a URL HTTP ou HTTPS solicitada e leva o foco até ele. Os dois nós usam a sessão persistente dos Portais, portanto cookies e web storage aprovados continuam compartilhados após reiniciar. Um pop-up real, como autenticação OAuth ou de pagamento, permanece numa janela sandboxed separada do Orkestrai porque esses protocolos dependem de window.opener e do ciclo de vida da janela filha; ele nunca escapa para o browser do sistema. Schemes privilegiados, URLs grandes demais e destinos inválidos são bloqueados antes de chegar ao renderer.`,
    },
    {
      id: 'managed-portal',
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Inicie o caso de uso guiado para validar a cadeia completa sem montar o Canvas manualmente. A cada avanço, o Orkestrai cria um Diretor Criativo Codex, briefings reutilizáveis de personagem e campanha, um logo PNG de teste e três workflows sequenciais: Personagem Master, Personagem com Marca e Carrossel XYZ. Fazer por mim dispara cada geração real; o tour só libera a próxima etapa depois de validar os arquivos no workspace e materializar os nodes Imagem. O primeiro resultado de uma etapa é conectado automaticamente como referência ordenada da seguinte, preservando prompts, caminhos, procedência e histórico. O exemplo gera três masters, duas poses com marca e três slides para uma validação rápida; cada workflow aceita até dez outputs. É necessária uma conta ou assinatura Codex autenticada com ImageGen, sem chave de API da OpenAI.',
...
},
{
  ...
  "items": [
    ...
    },
    {
      ...
      title: 'Orkestrai 0.25.0: workspace Remote completo em qualquer tela',
    ...
    },
    {
      ...
      title: 'Orkestrai 0.24.2: entrega confirmada de mensagens no Windows',
      ...
      items: [
        ...
        'Um redraw do terminal não conta mais como entrega: o Orkestrai confirma o prompt exato no transcript do provider e repete somente o Enter, dentro de um limite, quando necessário.',
    ...
    },
    {
      ...
      title: 'Orkestrai 0.24.1: dependências seguras e releases bloqueadas pela CI',
    ...
    },
    {
      ...
      title: 'Orkestrai 0.24.0: mova seleções completas do Canvas entre workspaces',
    ...
    },
    {
      ...
      items: [
        ...
        'O benchmark reproduzível do grafo valida o repositório Orkestrai, um espelho completo temporário e um repositório sintético contra as metas documentadas de busca, travessia e atualização incremental do SQLite; o espelho real de 1.672 arquivos permanece abaixo de dois segundos, portanto outro banco de grafo não se justifica.',
        'Instruções do workspace e de presets agora usam um bloco gerenciado e delimitado no AGENTS.md e, quando habilitado, no CLAUDE.md. O conteúdo existente do usuário é preservado, arquivos antigos controlados pelo Orkestrai migram com segurança e desabilitar a sincronização remove somente esse bloco.',
    ...
    },
    {
      ...
      items: [
        ...
        'Agentes novos ou recuperados nunca retomam a conversa mais recente de outro terminal: o Orkestrai retoma apenas o ID exato atribuído ao node e inicia uma conversa limpa quando esse vínculo ainda não existe.',
