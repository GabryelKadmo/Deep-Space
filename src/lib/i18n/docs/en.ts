  ...
  changelog: [
{
  ...
  "items": [
    ...
    "The agent bridge is unchanged on purpose: the deepspace command, the .deepspace/ directory, and the environment variables stay as they are, because renaming them would break existing workspaces."
  ]
},
{
