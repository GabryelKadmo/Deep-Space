  ...
  changelog: [
{
  ...
  "items": [
    ...
    "Usage lists a manually added profile right after the provider it belongs to, instead of at the end of the list. The leader-routing panel also lost the misaligned field: the window hint sat inside the grid and stretched a column."
  ]
},
{
