  ...
  changelog: [
{
  ...
  "items": [
    ...
    "Linking two nodes no longer depends on hitting a 20px target: the connection radius was widened, so releasing the rope near the destination node connects it. The connection dots on every node also stay visible for as long as a rope is being dragged — previously the destination node showed nothing, because its dots only appeared on hover and the pointer was captured by the drag.",
