...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      body: 'En Grafo de Código, abre Análisis y después Ejecución. Selecciona un repositorio indexado e indica una ruta relativa a él. La detección automática acepta LCOV .info, JUnit XML, stack traces comunes o el contrato JSON v1 limitado de Orkestrai que aparece abajo. Las rutas del JSON también son relativas al repositorio y las líneas empiezan en uno. El archivo está limitado a 5 MB; la cobertura admite hasta 50.000 ubicaciones y los fallos o llamadas hasta 5.000 relaciones. Orkestrai guarda solamente el hash del contenido, contadores, ids de símbolos mapeados, rutas, líneas y relaciones derivadas. Nunca persiste el archivo bruto, el texto de la stack, la salida de tests, valores de entorno ni cuerpos de código.',
      bullets: [
  ...
  "items": [
    ...
    },
    {
      ...
      items: [
        ...
        'Los visualizadores HTML del Cliente de API resuelven medios y estilos relativos contra la URL de la solicitud sin credenciales en vez del servidor local de Orkestrai, bajo un sandbox limitado que bloquea contenido activo.',
    ...
    },
    {
      ...
      items: [
        ...
        'Un redibujado de la terminal ya no cuenta como entrega: Orkestrai confirma el prompt exacto en el transcript del provider y repite solo Enter, dentro de un límite, cuando hace falta.',
