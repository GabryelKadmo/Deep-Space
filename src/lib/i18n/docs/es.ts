...
Header: Authorization = Bearer {{accessToken}}`,
    ...
    },
    {
      ...
      bullets: [
        ...
        'Usa orkestrai graph evidence import <projectId> <rutaRelativa> --kind auto en el terminal del agente, o la tool MCP code_graph_evidence_import equivalente.',
  ...
  useCases: [
    ...
    },
    {
      ...
      body: 'Abre Roles, elige "Descubrir en otra carpeta..." y selecciona el proyecto que contiene el rol. Deep Space valida los archivos limitados en .orkestrai/roles de ese proyecto, importa solo nombres nuevos y nunca sobrescribe un rol existente en el workspace.',
    ...
    },
    {
      ...
      body: 'Agrega servidores MCP en el editor del workspace (ej.: filesystem, web, base de datos) — los agentes ganan las tools nativamente, y el propio Deep Space aparece como servidor MCP con las acciones del canvas (orkestrai mcp). Los presets pueden cargar los MCPs junto con el equipo.',
  ...
  "items": [
    ...
    },
    {
      ...
      items: [
        ...
        'Las sesiones MCP y CLI restauradas sin ORKESTRAI_NODE_ID pueden registrar estado en el Centro de control mediante una tarea asignada al agente real del workspace; las llamadas sin ninguna de las dos fuentes de identidad verificadas siguen bloqueadas.',
    ...
    },
    {
      ...
      items: [
        'Agregado el botón "Descubrir en otra carpeta..." junto al discover del repositorio ya existente en Roles: elige cualquier carpeta en un diálogo nativo y Deep Space importa cada `role.json` encontrada dentro de `.orkestrai/roles/` ahí.',
