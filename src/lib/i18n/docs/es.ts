  ...
  changelog: [
{
  ...
  "items": [
    ...
    "La raíz de un workspace ya no se llena de archivos de skill/MCP de cada CLI compatible (Claude, Cline, Devin, Antigravity, OpenCode...) sin importar cuáles realmente se usan. La carpeta y el MCP dedicados de cada provider ahora solo aparecen cuando existe un terminal con ese provider, provisionados al momento en que se crea o se cambia. La skill portátil en .deepspace/ y el AGENTS.md, leídos por cualquier CLI sin archivo propio, no se ven afectados y siguen provisionándose de inmediato."
  ]
},
{
