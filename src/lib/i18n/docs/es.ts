  ...
  changelog: [
{
  ...
  "items": [
    ...
    "El puente de agentes sigue igual a propósito: el comando deepspace, la carpeta .deepspace/ y las variables de entorno no cambian, porque renombrarlas rompería workspaces existentes."
  ]
},
{
