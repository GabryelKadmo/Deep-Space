...
```text
relay.deepspace.app -> http://DROPLET_PRIVATE_IP:8787
```

Terminate TLS at the reverse proxy and verify
`https://relay.deepspace.app/health` before enabling the default relay in an
...
`DEEPSPACE_RELAY_ALLOWED_ORIGINS`.
