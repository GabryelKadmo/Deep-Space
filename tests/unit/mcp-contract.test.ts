...
const EXPECTED: Record<string, Expectation> = {
  ...
  design_manage_prototype_flow: { method: 'PATCH', path: /\/bridge\/designs\/n1$/, schema: bridgeDesignApplySchema },
  design_manage_prototype_interaction: { method: 'PATCH', path: /\/bridge\/designs\/n1$/, schema: bridgeDesignApplySchema },
...
const TOOL_ARGS: Record<string, Record<string, unknown>> = {
  ...
  image_workflow_update: { nodeId: 'n1', prompt: 'Updated art direction.', count: 10, outputPreset: 'custom', targetWidth: 1200, targetHeight: 1500 },
  ...
  image_workflow_run: { nodeId: 'n1', prompt: 'Create ten transparent character poses.', transparentBackground: true, count: 10, outputPreset: 'tiktok' },
  ...
  design_manage_prototype_interaction: {
    nodeId: 'n1',
    baseRevision: 0,
    operation: 'create',
    sourceElementId: '00000000-0000-7000-8000-000000000003',
    prototypeAction: { type: 'navigate', targetFrameId: '00000000-0000-7000-8000-000000000002' },
  },
