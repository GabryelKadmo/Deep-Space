...
- Apple Silicon: `DeepSpace-<v>-arm64.dmg`, its blockmap, `DeepSpace-<v>-arm64-mac.zip`, and its blockmap
- macOS Intel: `DeepSpace-<v>.dmg`, its blockmap, `DeepSpace-<v>-mac.zip`, and its blockmap
- Windows x64: `DeepSpace-Setup-<v>.exe` and its blockmap
- Linux x64: `DeepSpace-<v>.AppImage` (blockmap embedded) and `DeepSpace-<v>.x86_64.rpm`
